//EmbedMessage.java
 ...
 {
 JButton open = new JButton("Abrir imagen"), embed = new JButton("Cifrar"),
    save = new JButton("Salavar imagen"), reset = new JButton("Reset");
 ...
 public Encryption() {
    super("Esconder texto en imagen");
    assembleInterface();
...
//       getMaximumWindowBounds());
 ...
 private void assembleInterface() {
   ...
   save.addActionListener(this);   
    ...
    p.setBorder(BorderFactory.createTitledBorder("Escriba el mensaje a esconder"));
    this.getContentPane().add(p, BorderLayout.NORTH);
    
    sp.setLeftComponent(originalPane);
    sp.setRightComponent(embeddedPane);
    originalPane.setBorder(BorderFactory.createTitledBorder("Imagen original"));
    embeddedPane.setBorder(BorderFactory.createTitledBorder("Imagen esteganografiada"));
