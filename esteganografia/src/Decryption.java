//DecodeMessage.java
 ...
 {
 JButton open = new JButton("Abrir imagen"), decode = new JButton("Decifrar"),
 ...
 private void assembleInterface() {
    ...
    p.setBorder(BorderFactory.createTitledBorder("mensaje escondido"));
    message.setEditable(false);
    this.getContentPane().add(p, BorderLayout.SOUTH);
    
    imagePane.setBorder(BorderFactory.createTitledBorder("Imagen esteganografiada"));
 ...
 private java.io.File showFileDialog(boolean open) {
    JFileChooser fc = new JFileChooser("Abrir imagen");
